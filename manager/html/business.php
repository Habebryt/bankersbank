      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="business.php">Clients Businesses</a>
          </li>
        </ol>
      </nav>
      <div class="mb-3"></div>
      <div class="card">
        <h5 class="card-header">Clients Business</h5>
                      ...
                      <?php if (isset($accountNumber)) : ?>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="mybusiness.php?accountowner=<?php echo $code; ?>&accountnumber=<?php echo $accountNumber; ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
