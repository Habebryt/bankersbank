...
$tStatus = 'Pending';
$allTransactions = $transactions->pTransactions($managerId, $tStatus);
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="pending.php?transactionRef=<?php echo $ref ?>"><i class="bx bx-low-vision bx-flip-horizontal"></i> View</a>
                          </div>
                        </div>
                      </td>
                    </tr>
