...
<div class="layout-page">
  ...
  <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="mb-3">
        <button class="btn btn-primary disabled">Add Cash Loan</button>
      </div>
      <div class="card">
        <h5 class="card-header">Client Quick Loans</h5>
                      ...
                      <?php if (isset($accountNumber)) : ?>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="quickcash.php?accountowner=<?php echo $code; ?>&accountnumber=<?php echo $accountNumber; ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
