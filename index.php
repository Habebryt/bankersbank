  ...
  <div class="container flex-grow-1 container-p-y my-2">
    <div class="row mt-sm-4 mt-3">
      <div class="col-12 mb-3">
        <div class="card">
          <h5 class="card-header">Bankers Access</h5>

          <table class="table">
            <tbody>
              <tr>
                <th>Client Account</th>
                <td><a href="client/html/auth-login-basic.html" target="_blank">View Client Account Dashboard</a></td>
              </tr>
              <tr>
                <th>Account Manager</th>
                <td>
                  <a href="manager/html/auth-login-basic.html" target="_blank">View Account Manager Dashboard</a>
                </td>
              </tr>
              <tr>
                <th>Super Admin</th>
                <td>
                  <a href="admin/html/auth-login-basic.html" target="_blank">View Admin Dashboard</a>
                </td>
              </tr>
            </tbody>
          </table>
